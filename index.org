...
- [[https://github.com/sachac/book-lets-make-a-smoothie/raw/master/print-duplex-short-edge-flip.pdf][Placeholder PDF Ready for printing on 8.5"x14" paper in landscape mode, duplex, *short edge* flip]]
...
I'll put that in a subtree for easier exporting with =C-c C-e C-s l b= (=org-export-dispatch=, subtree, LaTeX, Beamer).
...
Use =pdflatex= to convert the .tex to PDF.

   #+begin_src sh :results silent
   pdflatex index.tex
   #+end_src

** Create one PNG per page with
