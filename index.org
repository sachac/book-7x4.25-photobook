...
- Tetex-live
- Beamer
- Org Mode and Emacs (optional)

** Set up Org Mode export to Beamer (optional)
...
#+begin_src emacs-lisp :var width=200 :var shadow=10 :results list
    (cl-loop
